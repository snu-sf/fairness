...
Section SPEC.
  ...
  Ltac red_tl_all := red_tl; red_tl_memra; red_tl_lifetime; red_tl_ghost_excl_ura.
  ...
  Proof.
    iIntros.
    red_tl; iIntros (γk); red_tl; iIntros (kt); red_tl; iIntros (k);
    ...
    { red_tl_all. rewrite red_syn_tgt_interp_as. iSplit; [eauto|]. iSplitR; [iFrame "#"|]. simpl.
      ...
      - iEval (red_tl_all; simpl) in "Bf". iDestruct "Bf" as "[LiveInv TStackC]".
        iDestruct (TStack_agree with "TStackInv TStackC") as %->.
        iMod (TStack_update with "TStackInv TStackC") as "[TStackInv TStackC]".
