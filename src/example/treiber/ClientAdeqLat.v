...
From Fairness.treiber Require Import SpecLat ClientCode ClientSpecLat.
...
Module TreiberClientCorrect.
  ...
  Lemma correct:
    UserSim.sim TreiberClientSpec.module TreiberClient.module
                (prog2ths TreiberClientSpec.module config) (prog2ths TreiberClient.module config).
  Proof.
...
End TreiberClientCorrect.

Section ALL.

  Definition client := TreiberClient.module.
  Definition client_spec := TreiberClientSpec.module.
  ...
  Proof.
    ...
    eapply usersim_adequacy. eapply TreiberClientCorrect.correct.
