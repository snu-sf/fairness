...
Section UPDNATMAP.
  ...
  Lemma NatMapRA_find_some {γ} m k a
    :
    own γ (● Map m)
      -∗
      own γ (◯ singleton k a)
  ...
  Proof.
    ...
    by iCombine "B W" gives
        %(_ & ?%NatMapRA.extends_singleton_iff & _)
        %auth_both_dfrac_valid_discrete.
  Qed.

  Lemma NatMapRA_singleton_unique {γ} k0 k1 a0 a1
    :
