...
Section FANCY_UPDATE.
  ...
  Global Instance from_modal_FUpd_free_all x A Es P :
    FromModal (OwnEs_top Es) modality_id P (FUpd x A Es ∅ P) P.
  Proof.
    rewrite /FromModal /FUpd. ss.
    iIntros (HE) "P (A & WSAT & EN)".
    iMod (OwnEs_free_all with "EN") as "EN". eauto. iModIntro. iFrame.
  Qed.
