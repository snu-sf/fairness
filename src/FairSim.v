...
Section SIM.
  ...
  Lemma _sim_ind2 (r: forall R0 R1 (RR: R0 -> R1 -> Prop), bool -> fmap  -> bool -> fmap -> Ident.(id) -> (itree eventE R0) -> (itree eventE R1) -> Prop)
        ...
        (FAIRL: forall
            ...
            P p_src m_src p_tgt m_tgt idx (ITree.bind (trigger (Fair m_src0)) ktr_src0) itr_tgt0)
        (FAIRR: forall
            ...
            P p_src m_src p_tgt m_tgt idx itr_src0 (ITree.bind (trigger (Fair m_tgt0)) ktr_tgt0))
        (PROGRESSS: forall
            p_src m_src p_tgt m_tgt idx itr_src0 itr_tgt0
            idx0
            (PSRC: p_src = true)
...
Section EX.
  ...
  Definition src1 : itree eventE nat := Ret 0.
