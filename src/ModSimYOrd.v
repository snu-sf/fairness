...
Section PRIMIVIESIM.
  ...
  Proof.
    ...
    eapply lsim_sync; eauto. i. hexploit LSIM. eauto. eapply INV0. eapply VALID0. all: eauto.
    i. des. esplits; eauto.
  Qed.
  ...
  Proof.
    ...
    { eapply pind9_fold. eapply lsim_sync; eauto. i.
      hexploit LSIM0. eauto. eapply INV0. eapply VALID0. all: eauto.
  ...
  Proof.
    ...
    { pfold. eapply pind9_fold. eapply lsim_sync; eauto. i.
      hexploit LSIM0. eauto. eapply INV0. eapply VALID0. all: eauto. i; des. esplits; eauto.
